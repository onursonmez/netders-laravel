...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('cancels')->truncate();
        DB::table('professions')->truncate();
        DB::table('groups')->truncate();
        DB::table('figures')->truncate();
        ...
        DB::table('places')->insert([
            'title' => 'Öğrenci Evinde', 
            'created_at' => date('Y-m-d H:i:s')
        ]);        

        DB::table('places')->insert([
            'title' => 'Eğitmen Evinde', 
            'created_at' => date('Y-m-d H:i:s')
        ]);  
        ...
        DB::table('times')->insert([
            'title' => 'Haftasonu gündüz', 
            'created_at' => date('Y-m-d H:i:s')
        ]);         
        
        DB::table('times')->insert([
            'title' => 'Haftasonu akşam', 
            'created_at' => date('Y-m-d H:i:s')
        ]);                 

        DB::table('discounts')->insert([
            'title' => 'Ücretsiz İlk Ders', 
            'created_at' => date('Y-m-d H:i:s')
        ]);                         

        DB::table('discounts')->insert([
            'title' => 'Üye öğrenci İndirimi', 
            'created_at' => date('Y-m-d H:i:s')
        ]);         
        ...
        DB::table('discounts')->insert([
            'title' => 'Engelli İndirimi', 
            'created_at' => date('Y-m-d H:i:s')
        ]);  
        
        DB::table('discounts')->insert([
            'title' => 'Öneri İndirimi', 
            'created_at' => date('Y-m-d H:i:s')
        ]);          

        DB::table('discounts')->insert([
            'title' => 'Paket Program İndirimi', 
            'created_at' => date('Y-m-d H:i:s')
        ]);                  

        $professions = DB::connection('mysql')->select('SELECT * FROM core_professions ORDER BY id ASC');
        ...
        $groups = DB::connection('mysql')->select('SELECT * FROM core_users_groups');
        ...
        $items = DB::connection('mysql')->select('SELECT * FROM core_users where email is not null and firstname is not null and lastname is not null order by id asc');
