...
<div class="card mt-4 box-shadow rounded-top">
	<div class="card-header">
		<h4 class="mb-0 pt-3 pb-3">Şifre Değiştirme</h4>
	</div>
	<div class="card-body">
        @include('utilities.alerts')

		<p>Yeni şifreni tanımlamak için aşağıdaki istediğin yeni şifre alanına gir.</p>

		<form  action="{{ url('auth/forgot_success') }}" method="post" class="ajax-form">
            @csrf
			<div class="row">
				<div class="form-group col-12 col-lg-3">
					<label class="text-muted">E-posta</label>
					<input readonly type="text" name="email" class="form-control" placeholder="E-posta adresin" value="{{ old('email') ?? app('request')->email }}">
				</div>
				<div class="form-group col-12 col-lg-3">
					<label class="text-muted">İstediğin yeni şifre</label>
					<input type="password" name="new_password" class="form-control" placeholder="İstediğin yeni şifre">
				</div>                
				<div class="form-group col-12 col-lg-3">
